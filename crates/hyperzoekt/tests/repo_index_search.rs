...
fn make_simple_svc() -> RepoIndexService {
    ...
    let e0 = StoredEntity {
        id: 0,
        file_id: 0,
        kind: hyperzoekt::repo_index::indexer::types::EntityKind::Function,
        name: "foo".into(),
        parent: None,
        signature: "".into(),
        start_line: 1,
    ...
    RepoIndexService {
        ...
        rank_weights: hyperzoekt::repo_index::indexer::types::RankWeights::default(),
    }
}
