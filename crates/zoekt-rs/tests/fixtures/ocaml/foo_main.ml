( *
  ...
  and determine
which subcommand to execute, calling
  a function from our library
accordingly.
*)
...
( *
  ...
  You may want to use
Arg.parse_argv to read the remaining
  command-line arguments.
*)
let run
_argv_offset = Proj_sub2.A.do_something ()

let walk _argv_offset = print_endline
"Nice."
