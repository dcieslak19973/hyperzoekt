...
| hyperzoektHiragWorker.env[0].name | string | `"HZ_LLM_URL"` |  |
| hyperzoektHiragWorker.env[0].value | string | `"http://localhost:11434"` |  |
| hyperzoektHiragWorker.exposure.ingress.enabled | bool | `false` |  |
| hyperzoektHiragWorker.exposure.ingress.host | string | `"hirag.hyperzoekt.local"` |  |
| hyperzoektHiragWorker.exposure.ingress.path | string | `"/"` |  |
| hyperzoektHiragWorker.exposure.ingress.pathType | string | `"Prefix"` |  |
